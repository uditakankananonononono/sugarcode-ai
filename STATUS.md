# SugarCode AI - honest status (as of drop 32 / this push)
...
Test suite: **388 passed, 0 failed** (hermetic fixtures; live calls verified
...
| deepsplice GJB2 5'-UTR intron golden | GJB2 (the one harvested gene excluded in drop 29 for its single-exon CDS) now has scoring-level golden coverage of its 5'-UTR intron on real NM_004004.6 mRNA windows (NG_008358.1). All 3 pathogenic ClinVar UTR variants called loss: c.-23+1G>A donor (delta -0.254), c.-22-1G>A + expert-panel c.-22-2A>C acceptors (-0.184). Honest scope: scoring golden via variant_at; live_splice_assessment does NOT yet route negative (UTR) c. numbers (answers "outside scope") - routing extension is a documented next candidate. No benign cases in window (benign c.-23+12G>A at +12; c.-22-2A>G conflicting, excluded) | ClinVar live + NG_008358.1 (hermetic test) |
