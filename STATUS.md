# SugarCode AI - honest status (as of drop 27 / this push)
...
Test suite: **360 passed, 0 failed** (hermetic fixtures; live calls verified
...
| deepsplice multi-gene golden | 17 genes (+ MSH6, PMS2, APC, ATM, RB1, PTEN, PAH, LDLR, SCN1A, MECP2): pooled 2,059 pathogenic + 63 benign ClinVar splice SNVs on title-verified junction maps. ALL 1,818 canonical +/-1/+/-2 sites called loss (100%): 1,810 U2 (GT/GC-AG) + 8 AT-AC scored with the new U12 matrices; benign specificity 62/63 (98%, the one FP is the documented BRCA1 c.594-2A>C). Transcript overrides verified live: APC NM_000038 (record span-matches NM_001127511.1), MECP2 NM_001110792; SCN1A now uses a NATIVE NM_001165963 junction map (cdna_junction_map) - drop-26 hand remap superseded | NCBI ClinVar + RefSeqGene x17 |
