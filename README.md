...
| deepsplice | splice PWMs learned from 1,170 real RefSeqGene GT-AG junctions (29 title-verified genes) + U12 minor-spliceosome matrices from 500 human gold introns (intronIC index); variant delta + isoform calls calibrated on a 2,122-case, 17-gene ClinVar golden set (100% of ALL 1,818 canonical sites called loss: GT/GC-AG and AT-AC), transcript-isoform junction maps via cDNA-record alignment (SCN1A NM_001165963 native), exon-skip in-frame/frameshift context, cryptic-site activation scan validated on the published CFTR 3849+10kbC>T pseudoexon case |
